...
public:
    ...
    // Processes the images: thresholding, masking, optical flow, and wind speed estimation
    // timeDifference is in hours (or any arbitrary unit depending on satellite pass frequency)
